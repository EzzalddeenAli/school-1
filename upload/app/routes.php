...
Route::group(array('before' => 'api.csrf'), function () {
	Route::post('/ThemeController/changeTopNavColor', 'ThemeController@changeTopNavColor');
	Route::post('/ThemeController/changeBoxLayout', 'ThemeController@changeBoxLayout');
	Route::post('/ThemeController/changeCollapseNav', 'ThemeController@changeCollapseNav');
	Route::post('/ThemeController/changeSidebarColor', 'ThemeController@changeSidebarColor');
	Route::post('/ThemeController/changeFixHeader', 'ThemeController@changeFixHeader');
});
